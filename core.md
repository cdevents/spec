...
| Status | `Enum` | Status of a finished `PipelineRun` | `success`, `error` or `failure`|
...
| Status | `Enum` | Status of a finished `TaskRun` | `success`, `error` or `failure`|
...
| Field         | Mandatory ✅<br/>Permitted ⚪<br/>Not Permitted 🟥 |
|---------------|:---------:|
| ID            | ✅ |
| Source        | ⚪ |
| PipelineName  | ✅ |
